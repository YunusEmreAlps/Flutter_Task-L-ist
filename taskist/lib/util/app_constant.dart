...
class AppConstant {
  // Colors
  static final Color colorPrimary = Color(0xFF26BFCA);
  static final Color colorPageBg = Color(0xFFF8F8F8);
  static final Color colorPageBg2 = Color(0xFFE1E2E7);
  static final Color colorDelete = Color(0xFFFD2D1F);
  static final Color kSecondaryLightColor = Color(0xFFE4E9F2);
  static final Color kSecondaryDarkColor = Color(0xFF404040);
  static final Color kAccentLightColor = Color(0xFFB3BFD7);
  static final Color kAccentDarkColor = Color(0xFF4E4E4E); // 4E4E4E
  static final Color kBackgroundDarkColor = Color(0xFF3A3A3A); // 3A3A3A
...
// Text Colors
  ...
  // Priority
  static final Color colorPriorityUrgent = Color(0xFFEF301A);
  static final Color colorPriorityHigh = Color(0xFFFF7643);
  static final Color colorPriorityMedium = Color(0xFFF2BF06);
  static final Color colorPriorityLow = Color(0xFF1FF0B0);
  static final Color colorPriorityDefault = Color(0xFF7268F6);
  ...
  // Strings
  static final String appName = 'Task Manager'; // Task List
  ...
  // Assets
  static final String svgSun = "assets/icons/sun.svg";
  static final String svgMoon = "assets/icons/moon.svg";
}
